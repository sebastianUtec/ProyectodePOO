...
#ifndef PROYECTOFINALPOOII_2019_2_SEB_CROBOT_H
#define PROYECTOFINALPOOII_2019_2_SEB_CROBOT_H
...
public:
    CRobot();
    CRobot(TipoEntero Posicion_X ,TipoEntero Posicion_Y,TipoEntero Vida_del_Objeto,TipoEntero Tamanio_de_Ataque,Caracter Caracter_del_Objeto,string Nombre_del_Objeto);
    ~CRobot();
...
#endif //PROYECTOFINALPOOII_2019_2_SEB_CROBOT_H
